# This bash script is responsible for the pre-trained bert gender model and human captions
...
for model in ${models[@]}; do
    ...
    echo "----------------------------"
    python3 bert_leakage.py --seed 0 --num_epochs 1 --calc_ann_leak True --cap_model $model --freeze_bert True
done