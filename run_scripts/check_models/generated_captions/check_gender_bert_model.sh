# This bash script is responsible for the gender bert model and generated captions
...
for model in ${models[@]}; do
    ...
    echo "----------------------------"
    # Change bert_leakage and calc_model_leak for generated captions
    python3 bert_leakage.py --seed 0 --num_epochs 1 --calc_model_leak True --cap_model $model
done
